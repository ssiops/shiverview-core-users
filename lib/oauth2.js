...
function OAuth (opt) {
  ...
  if (typeof opt === 'string')
    ...
    return null;
  this.id = opt.id || config.client_id;
  this.secret = opt.secret || config.client_secret;
  this.redirect = opt.redirect || config.redirect_uri;
  this.key = opt.key || config.api_key;
  return this;
}
